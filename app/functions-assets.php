...
add_action( 'wp_enqueue_scripts', function() {
	...
	wp_enqueue_script( 'mag-app', asset( 'js/app.js' ), null, null, true );

	// Enqueue theme styles.
	wp_enqueue_style( 'mag-screen', asset( 'css/screen.css' ), null, null );
...
add_action( 'enqueue_block_editor_assets', function() {
	...
	wp_enqueue_style( 'mag-editor', asset( 'css/editor.css' ), null, null );
